...
bool InputGeom::useMesh(rcMeshLoaderObj* mesh)
{
	m_mesh = mesh;
	...
	if (!rcCreateChunkyTriMesh(m_mesh->getVerts(), m_mesh->getVertCount(), m_mesh->getTris(), m_mesh->getTriCount(), 256, m_chunkyMesh))
	{
		return false;
	}
